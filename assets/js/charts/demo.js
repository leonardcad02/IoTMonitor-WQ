 $(function() {   
      ...
      =======================================================*/
        ...
        if($("#orderRevenue").length) {
            ...
            var revChart = new Chart( ctx, {
              type: 'line',
              data: {
                  labels: ["March", "April", "May", "June", "July", "August", "Semptember"],
                  datasets: [
                      {
                          label: "Ph",
                          borderColor: "rgb(255, 36, 66)",
                          borderWidth: "3",
                          backgroundColor: "rgb(255, 36, 66, 0.2)",
                          data: [8.99, 9.21, 8.84, 9.8, 9.27 ,9.02,8.91]
                                  },
                      {
                          label: "Dissolved Oxygen",
                          borderColor: "rgb(255, 211, 113)",
                          borderWidth: "3",
                          backgroundColor: "rgba(255, 211, 113,0.9)",
                          data: [5.92, 5.97 , 5.97, 5.95 , 5.91, 5.97, 5.88],
                      },
                      {
                        label: "Conductivity",
                        borderColor: "rgb(113, 239, 163)",
                        borderWidth: "3",
                        backgroundColor: "rgba(113, 239, 163, 0.5)",
                        data: [182.508 ,192.248 , 188.138, 195.368, 180.958, 186.568, 200.458],
                       }
                              ]
              },
              options: {
      ...
      if($("#Ph").length) {
        $('#Ph').sparkline([9.65, 9.67,9.32,8.81,9.46,9.22,9.43,8.73,9.05,9.73,9.06,9.41,9.51,9.65,9.21,9.14], { 
          type: 'bar',
          barColor: ['#DF2E2E'],
          barWidth: '15px',
          height: '60px',
      ...
      if($("#Dissolved").length) {
        $('#Dissolved').sparkline([5.91,5.86,5.98,5.88,5.94,5.92,5.88,6.01,5.98,5.99,6.01,5.93,5.93,5.88,6.01,5.98,5.99,6.01,5.93,5.93], { 
          type: 'bar',
          barColor: ['#FFF338'],
          barWidth: '15px',
          height: '60px',
      ...
      if($("#Conductivity").length) {
        $('#Conductivity').sparkline([186.958, 181.188, 194.808, 186.458, 193.768, 190.588,198.478,198.698,184.428, 193.408, 194.438,183.788,196.408,190.588,198.478,198.698,184.428, 193.408, 194.438,183.788,196.408], { 
          type: 'bar',
      ...
      if($("#Temperature").length) {
        $('#Temperature').sparkline([19.56,19.18,19.34,18.87,19.22,19.52,19.67,20.3,20.08,19.98,23.4,20.67,20.8,19.93, 20.42,19.32,21.34,20.42,19.32,21.34], { 
          type: 'bar',
          barColor: ['#F9B208'],
          barWidth: '15px',
          height: '60px',
      ...
      if($("#Humidity").length) {
        $('#Humidity').sparkline([77,77,77,77,77,77,77,77,77,77,77,77,77,77,76,77,77,77,77,77], { 
          type: 'bar',
          barColor: ['#2D46B9'],
          barWidth: '15px',
          height: '60px',
      ...
      $(window).resize(function() {
        $('#Ph canvas').css("width","100%");
        $('#Dissolved canvas').css("width","100%");
        $('#Conductivity canvas').css("width","100%");
        $('#Temperature canvas').css("width","100%");
        $('#Humidity canvas').css("width","100%");
        $('#Flow canvas').css("width","100%");
      });
